...
use Alipay\Sdk\Model\Result\AlipayTradePrecreateRequest as AlipayTradePrecreateRequest;
use Alipay\Sdk\Aop\AopClient as AopClient;
use Alipay\Sdk\Model\Result\AlipayF2FPrecreateResult as AlipayF2FPrecreateResult;
use Alipay\Sdk\Model\Result\AlipayTradeQueryRequest as AlipayTradeQueryRequest;
use Alipay\Sdk\Model\Result\AlipayF2FQueryResult as AlipayF2FQueryResult;
use Alipay\Sdk\Model\Result\AlipayTradeRefundRequest as AlipayTradeRefundRequest;
use Alipay\Sdk\Model\Result\AlipayF2FRefundResult as AlipayF2FRefundResult;
...
class AlipayTradeService {
	...
	function writeLog($text) {
		...
		//$text = characet ( $text );
		//file_put_contents ( "/Users/caige/php/lottery/api/runtime/log.txt", date ( "Y-m-d H:i:s" ) . "  " . $text . "\r\n", FILE_APPEND );
	}
